...
| `get_fastest_route_action` | 최단 행동, 도착 마감, 늦음 회복, 교통 비교 | "퇴근", "홍대입구 빨리", "약속 늦었어" |
...
| 9 | 약속 늦었어 | `get_fastest_route_action` | 목적지 질문 (clarification) |
...
비 오는 날 context도 지원합니다 (쿼리에 "비" 포함 시 택시 우선).
...
- Tool selection guide:
  - 빠른 길, 최단, 늦음, 도착 마감, 출근/퇴근 기본 질의 → `get_fastest_route_action`
