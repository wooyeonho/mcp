...
const fixtures: RouteFixture[] = [
  {
    ...
    routes: () => [
      { mode: "subway", durationMinutes: 38, line: "2호선", direction: "신림 방면", boardAt: "강남역", alightAt: "신림역", firstWalkMinutes: 5, lastWalkMinutes: 6, fareKrw: 1550, missedFallback: "다음 열차 4~6분 뒤 출발합니다. 2호선 배차가 짧으니 걱정 마세요." },
      { mode: "bus", durationMinutes: 47, busNumber: "146번", boardAt: "강남역 정류장", alightAt: "신림역 정류장", firstWalkMinutes: 4, lastWalkMinutes: 7, fareKrw: 1500, missedFallback: "146번을 놓치면 5008번으로 전환하세요. 배차 7분입니다." },
      { mode: "taxi", durationMinutes: 32, boardAt: "강남역 2번 출구", alightAt: "신림역", firstWalkMinutes: 1, lastWalkMinutes: 1, taxiFareKrw: 18000, missedFallback: "택시가 안 잡히면 바로 지하철로 전환하세요." },
    ],
    good: (req) => {
  ...
  },
  {
    ...
    routes: () => [
      { mode: "subway", durationMinutes: 36, line: "2호선", direction: "강남 방면", boardAt: "신림역", alightAt: "강남역", firstWalkMinutes: 4, lastWalkMinutes: 5, fareKrw: 1550, missedFallback: "다음 열차 3~5분 뒤입니다. 출근 시간대 배차 짧습니다." },
      { mode: "bus", durationMinutes: 44, busNumber: "5008번", boardAt: "신림역 정류장", alightAt: "강남역 정류장", firstWalkMinutes: 3, lastWalkMinutes: 6, fareKrw: 1500, missedFallback: "5008번 놓치면 146번 기다리세요. 같은 정류장입니다." },
      { mode: "taxi", durationMinutes: 28, boardAt: "신림역 3번 출구", alightAt: "강남역", firstWalkMinutes: 1, lastWalkMinutes: 1, taxiFareKrw: 17000, missedFallback: "택시 대기 길면 지하철이 더 빠릅니다." },
    ],
  ...
  },
  {
    ...
    routes: () => [
      { mode: "subway", durationMinutes: 28, line: "2호선", direction: "홍대입구 방면", boardAt: "강남역", alightAt: "홍대입구역", firstWalkMinutes: 4, lastWalkMinutes: 3, fareKrw: 1550, missedFallback: "2호선 내선순환 다음 열차 3분 뒤입니다." },
      { mode: "bus", durationMinutes: 42, busNumber: "472번", boardAt: "강남역 정류장", alightAt: "홍대입구 정류장", firstWalkMinutes: 5, lastWalkMinutes: 5, fareKrw: 1500, missedFallback: "472번 놓치면 지하철로 전환하세요. 더 빠릅니다." },
      { mode: "taxi", durationMinutes: 22, boardAt: "강남역 5번 출구", alightAt: "홍대입구", firstWalkMinutes: 1, lastWalkMinutes: 1, taxiFareKrw: 15000, missedFallback: "택시가 바로 안 잡히면 지하철 2호선이 확실합니다." },
    ],
    good: (req) => {
  ...
  },
  {
    ...
    routes: (req) => [
      ...
      { mode: "taxi", durationMinutes: 30, boardAt: req.origin, alightAt: req.destination, firstWalkMinutes: 1, lastWalkMinutes: 1, taxiFareKrw: 22000, missedFallback: "병원 예약 시간이 촉박하면 택시가 확실합니다." },
    ],
  ...
  },
  {
    ...
    routes: (req) => [
      ...
      { mode: "taxi", durationMinutes: 25, boardAt: req.origin, alightAt: req.destination, firstWalkMinutes: 1, lastWalkMinutes: 1, taxiFareKrw: 16000, missedFallback: "택시가 안 잡히면 지하철이 확실합니다." },
    ],
    good: (req) => {
      const isCafe = !req.placeType || req.placeType === "cafe" || req.mood === "romantic";
