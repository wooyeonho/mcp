...
export async function saveUserPlaces(input: z.infer<z.ZodObject<typeof saveUserPlacesSchema>>) {
  saveProfile({ home: input.home, work: input.work, aliases: input.aliases });
